...
static int read_num_class_data( const char* filename, int var_count,
...
static int build_rtrees_classifier( char* data_filename,
...
static int build_boost_classifier( char* data_filename,
    char* filename_to_save, char* filename_to_load )
{
...
static int build_mlp_classifier( char* data_filename,
    char* filename_to_save, char* filename_to_load )
{
    const int class_count = 26;
    CvMat* data = 0;
...
static int build_knearest_classifier( char* data_filename, int K )
{
...
static int build_nbayes_classifier( char* data_filename )
{
    const int var_count = 16;
    CvMat* data = 0;
    CvMat train_data;
...
static int build_svm_classifier( char* data_filename, const char* filename_to_save, const char* filename_to_load )
{
    CvMat* data = 0;
    CvMat* responses = 0;
    CvMat* train_resp = 0;
...
int adip::letter_recognize(Mat org_image, Mat *mod_image) {
    char data_filename[] = "data/letter-recognition.data";
